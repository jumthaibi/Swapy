...
if (isset($_POST['add_employee_submit'])) {
    ...
    // تشفير كلمة المرور لو كنتوا بتستخدموا تشفير بالمشروع (مثلاً MD5 أو password_hash)
    // إذا ما بتستخدموا تشفير، امسحي سطر الـ md5 وخلي المتغير كالعادي
...
<nav class="navbar">
    ...
    <a href="index.php" class="nav-logo">
        ...
        <span class="nav-context">| Admin Dashboard</span>
    ...
    <button onclick="toggleEmployeeForm()" class="add-employee-btn">
    ...
    <div class="nav-right">
        <a href="../portal/staff_profile.php" class="profile-link">
            ...
            <?php if (!empty($admin_pic)): ?>
                <img
                    src="../image.php?entity=user&amp;id=<?php echo (int)$admin_id; ?>"
                    class="header-avatar"
                    alt="Profile"
                >
            <?php else: ?>
                <img
                    src="https://ui-avatars.com/api/?name=<?php echo urlencode($admin_name); ?>&background=fbbf24&color=fff"
                    class="header-avatar"
                    alt="Profile"
                >
            <?php endif; ?>
