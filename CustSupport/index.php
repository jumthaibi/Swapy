...
<nav class="navbar">
    <a href="index.php" class="nav-logo">
        SWAPY
        <span class="nav-context">| Customer Support</span>
    </a>
    ...
    <div class="nav-right">
        <a href="../portal/staff_profile.php" class="profile-link">
            ...
            <?php if (!empty($staff_pic)): ?>
                <img src="../image.php?entity=user&amp;id=<?php echo (int)$staff_id; ?>" class="header-avatar" alt="Profile">
            <?php else: ?>
    ...
    <div class="dashboard-tabs">
        <button class="tab-btn active" style="cursor: default;">
            ...
            <span class="section-button-copy">
                ...
                <small>Review complaints and support requests</small>
            </span>
            <span class="support-tab-count"><?php echo mysqli_num_rows($complaints_query); ?></span>
        </button>
    </div>
        ...
        <?php if (mysqli_num_rows($complaints_query) > 0): ?>
            <?php while ($complaint = mysqli_fetch_assoc($complaints_query)): ?>
                <div class="review-card" id="complaint-card-<?php echo $complaint['id']; ?>">
                    ...
                    <div class="item-info">
                        <span class="meta-tag <?php echo $complaint['status'] === 'closed' ? 'meta-tag-approved' : 'meta-tag-pending'; ?>">
